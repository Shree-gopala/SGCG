  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1">
        {/* Hero Banner (Restored original structure with light colors) */}
        <section className="relative pt-32 pb-14 md:pt-40 md:pb-16 bg-gradient-to-r from-orange-50 via-white to-orange-100/40 border-b border-orange-100/50 overflow-hidden">
          <div className="relative z-10 max-w-6xl mx-auto px-4 md:px-8">
            ...
            <div className="flex flex-wrap items-center gap-3 mb-3">
              ...
              <span className="bg-orange-550 text-orange-800 border border-orange-100/50 text-sm font-mono px-3 py-1 rounded-full">
                {product.formula}
              </span>
              <span className="bg-gray-150 text-gray-600 text-xs px-3 py-1 rounded-full">
                {product.cas}
              </span>
            </div>
            <h1 className="font-serif text-3xl md:text-5xl text-gray-900 font-bold mb-2">
              {product.name}
            </h1>
            {product.subtitle && (
              <p className="text-gray-600 text-sm font-mono mb-1">{product.subtitle}</p>
            )}
            <p className="text-gray-500 text-sm">{product.form}</p>
          </div>
        </section>
          ...
          <ScrollReveal className="max-w-6xl mx-auto px-4 md:px-8">
            <div className="grid lg:grid-cols-3 gap-8 items-start">
              ...
              <div className="lg:col-span-2 space-y-7">
                ...
                {/* TECHNICAL SPECIFICATIONS (Restored original style) */}
                ...
                {/* KEY APPLICATIONS (Restored original keyApplications layout) */}
                ...
                {/* QUALITY ASSURANCE + BADGES (Restored original style but with light colors) */}
              ...
              <div className="space-y-5 lg:sticky lg:top-28">
                ...
                {/* Grades / Purity (Restored original purityGrades field) */}
                ...
                {/* Request a Quote (Restored original style) */}
        ...
        {/* CTA Section (Restored original style with light colors) */}
